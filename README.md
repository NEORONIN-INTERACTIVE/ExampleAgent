# Example Agent
This example agent provides the minimum setup required to compete in the W4A tournament. Please follow the instructions to set it up for your competition agent.
